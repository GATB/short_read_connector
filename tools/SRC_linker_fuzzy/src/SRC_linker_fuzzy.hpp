...
#ifndef _TOOL_SRC_linker_fuzzy_HPP_
#define _TOOL_SRC_linker_fuzzy_HPP_
...
class SRC_linker_fuzzy : public Tool
{
...
public:
    ...
    void parse_query_sequences(int threshold, const int nbCores, const int windows_size);
};

/********************************************************************************/

#endif /* _TOOL_SRC_linker_fuzzy_HPP_ */
